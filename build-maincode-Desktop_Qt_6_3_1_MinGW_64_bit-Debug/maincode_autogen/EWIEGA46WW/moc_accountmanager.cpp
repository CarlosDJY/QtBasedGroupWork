...
#include <memory>
#include "../../../mainCode/accountmanager.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AccountManager_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_AccountManager_t qt_meta_stringdata_AccountManager = {
    {
QT_MOC_LITERAL(0, 14) // "AccountManager"
...
const QMetaObject AccountManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_AccountManager.offsetsAndSize,
    qt_meta_data_AccountManager,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AccountManager_t
